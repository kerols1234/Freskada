    ...
    public partial class createDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseMaterials", x => new { x.MaterialId, x.PurchaseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseMaterials_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionMaterials", x => new { x.MaterialId, x.SessionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseMaterials_PurchaseId",
